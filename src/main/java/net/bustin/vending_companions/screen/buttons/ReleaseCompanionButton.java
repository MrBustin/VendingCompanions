...
public class ReleaseCompanionButton extends Button {
    private final ResourceLocation normalTex;
    private final ResourceLocation hoverTex;
    private final Component tooltip;
    public ReleaseCompanionButton(int x, int y, int w, int h, ResourceLocation normalTex, ResourceLocation hoverTex, Component tooltip, OnPress onPress) {
